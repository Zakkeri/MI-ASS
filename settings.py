...
'Tel_Reg_Exp' : "(A{1,4}(C{4}A{4})*C{0,4})|(C{1,4}(A{4}C{4})*A{0,4})|(T{1,4}(G{4}T{4})*G{0,4})|(G{1,4}(T{4}G{4})*T{0,4})|(A{0,4}(C{4}A{4})*C{1,4})|(C{0,4}(A{4}C{4})*A{1,4})|(T{0,4}(G{4}T{4})*G{1,4})|(G{0,4}(T{4}G{4})*T{1,4})|(A{1,4}C{4}A{1,4})|(C{1,4}A{4}C{1,4})|(T{1,4}G{4}T{1,4})|(G{1,4}T{4}G{1,4})"
}
...
Main Algorithm can be found under http://knot.math.usf.edu/mi-ass/algorithm.html
...
settings.py consists of the parameters that can be changed before running the program. Make sure that 5' and 3' telomeric 
regular expressions corresponding to your organism are set properly.
...
Disable Debugging before running the program to avoid getting unnecessary outputs.